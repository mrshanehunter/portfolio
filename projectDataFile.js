const brandData = [
    ...
    {id: 2,
        ...
        brand: 'Ask The Tarot',
        desc1: `Ask The Tarot offers tarot and chakra card readings online from a bespoke e-commmerce platform. `,   
        desc2: `It's an example of a hobby turned side hustle seeking to expand its reach and revenue base via the internet.`,
        creative: './assets/assetsCreative/ATTCreative.jpg',
        brief: `Create the branding and design, build and deploy a new website that doesn't look like an "out of the box" solution. Specifically avoid anything that looks too "flaky".`,
        solution1: 'The original Ask The Tarot website, built using Wordpress, provided a reference point for developing the brand identity. Further insights came from client interviews and answers to the standard questionnaire used by That Guy From Marketing&reg; to understand the "why" component of the business.',   
        solution2: `Researching the market identified elements to avoid in order to achieve the non-flaky objective, and guided the use of colour and iconography in order to position the brand as a reliable expert in the minds of the target market.  Consumer psychology also played a significant role in the determination of the final colour palette.`,
        solution3: `UX interviews guided the design process, with newly approved branding informing the UI element. The end result was the bespoke and unique look specified in the brief. While the finished product doesn't rely on any standard CMS, with minimal training the client is able to make copy and product range amendments easily.  The tailored approach also means new features can be developed, tested and deployed quickly and efficiently.`,
       },
       {id: 3,
        name: 'Infrusion',
